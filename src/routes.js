...
import CRMProfileScreen from './CRMHome';
import CRMHistoryScreen from './CRMHome';
import CRMAccountScreen from './CRMHome';
...
const AppNavigator = StackNavigator({
    home: { screen: Home },
    crmHome: { screen: CRMHome },
    crmProfile: { screen: CRMProfileScreen },
    crmHistory: { screen: CRMHistoryScreen },
    crmAccount: { screen: CRMAccountScreen },
